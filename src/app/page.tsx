...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#fdf6f0] to-[#e7e0d8] text-black scroll-smooth">
      {/* Navigation */}
      <nav className="sticky top-0 z-50 flex flex-wrap justify-between items-center px-6 md:px-10 py-4 bg-white/40 backdrop-blur-md shadow-md">
        ...
        <div className="w-full max-w-6xl bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-6 md:p-10 animate-slide-up">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
            ...
            <div className="flex-1 text-justify space-y-4">
              ...
              <p>
                I&apos;m Narges, an AI engineer and data scientist driven by curiosity. My journey into tech started with puzzles and creative exploration, evolving into a passion for building intuitive, human-centered AI systems.
              </p>

              <p>
                At <strong>IBM Research Zurich</strong>, I built conversational geospatial agents, fine-tuned LLMs with QLoRA, and created RAG systems for natural NL-to-SQL interaction. At <strong>Basler &amp; Hofmann</strong>, I developed digital twin tools using voxel-based CNNs and LLM-powered automation. At <strong>iHomeLab</strong>, I explored real-time prediction systems in smart buildings and agriculture.
              </p>

              <p>
                I care about people, purpose, and collaborative energy. I bring clarity to ambiguity and momentum to complex projects—with warmth, curiosity, and intention.
              </p>

              <p>
                Outside of work, I ski, hike, and explore design, astronomy, and quantum physics. I paint, sculpt, and dream up furniture concepts when I need to recharge.
              </p>

              <p>
                Curious about the creative side? Visit my{' '}
                <a
                ...
                . Want to see what I’m building in AI? Check out my{' '}
                <a
